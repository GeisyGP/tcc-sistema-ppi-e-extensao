...
import { createUserSchema } from '@/validations/user.schem'
...
type UserModalProps = {
    isOpen: boolean
    onClose: () => void
    onSave: (created: CreateUserReq) => void
}

export function UserModal({ isOpen, onClose, onSave }: UserModalProps) {
    const [courses, setCourses] = useState<{ label: string; value: string }[]>([])
    const [coursesLoaded, seCoursesLoaded] = useState(false)
